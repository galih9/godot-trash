...
/** @type {string} */
const CACHE_VERSION = '1765949531|5005170972';
/** @type {string} */
const CACHE_PREFIX = 'trash game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'trash game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["trash game.html","trash game.js","trash game.offline.html","trash game.icon.png","trash game.apple-touch-icon.png","trash game.audio.worklet.js","trash game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["trash game.wasm","trash game.pck"];
